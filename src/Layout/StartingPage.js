...
/**
 * Component for displaying the links to the login and register pages.
 * @returns {JSX.Element} The StartingPage component.
 */
        ...
        <div className="min-h-screen flex justify-center items-center bg-gray-100">
            <div className="max-w-md bg-white shadow-md rounded-xl px-8 pt-6 pb-8 mb-4">
                ...
                <div className="flex justify-center">
                    <Link
                        to="/login"
                        className="bg-secondary hover:bg-orange-400 text-white font-bold py-2 px-4 rounded mr-4 focus:outline-none focus:shadow-outline"
                    >
                        Login
                    </Link>
                    <Link
                        to="/register"
                        className="bg-primary hover:bg-orange-400 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                    >
                        Register
                    </Link>
                </div>
